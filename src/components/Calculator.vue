...
.display {
  grid-column: 1/5;
  background-color: rgb(59, 38, 81);
  color: rgb(251, 223, 255);
}
.btn {
  background-color: rgb(228, 195, 242);
  border: 1px solid rgb(202, 145, 172);
}
.operator {
  background-color: rgb(159, 0, 112);
